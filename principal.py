...
# CRUD CLIENTE
data_clientes:list=[{"numero_documento":"70900618  ",
                     "razon_social":"Obed Michael Huarsocca Huarsocca  ",
                     "direccion":"Jr. Tupac yupanqui 590  ",
                     "telefono":"994067278"},
                     {"numero_documento":"74471807  ",
                     "razon_social":"Yorch Cruz Mamani                 ",
                     "direccion":"Salida lampa            ",
                     "telefono":"989046599"},
                     {"numero_documento":"73976237  ",
                     "razon_social":"Jorsh anderson calcina chua       ",
                     "direccion":"sumac illari            ",
                     "telefono":"938899989"},
                     {"numero_documento":"73233666  ",
                     "razon_social":"Marcelo Torres Miranda                 ",
                     "direccion":"La Capilla          ",
                     "telefono":"938272056"}]
...
def insertar_venta():
    ...
    buscar_venta_impresion(len(ventas))
...
def buscar_venta_impresion(numero):
    print(numero)
    for venta in ventas:
